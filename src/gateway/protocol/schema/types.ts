...
export type HubSearchParams = Static<typeof HubSearchParamsSchema>;
export type HubInstallParams = Static<typeof HubInstallParamsSchema>;
export type HubTestParams = Static<typeof HubTestParamsSchema>;
